...
export type Database = {
  ...
  public: {
    Tables: {
      customer_payments: {
        Row: {
          ...
          customer_id: string;
          id: string;
          lipa_namba_provider: Database["public"]["Enums"]["lipa_namba_provider"] | null;
          note: string | null;
    ...
    Enums: {
      expense_category:
        "rent" | "electricity" | "transport" | "salaries" | "stock_purchase" | "other";
      lipa_namba_provider: "mpesa" | "airtel_money" | "tigo_pesa";
      payment_method: "cash" | "lipa_namba";
      sale_status: "completed" | "voided";
      sale_type: "cash" | "credit";
      stock_movement_type: "restock" | "adjustment" | "sale_deduction" | "void_restore";
...
export const Constants = {
  public: {
    Enums: {
      expense_category: ["rent", "electricity", "transport", "salaries", "stock_purchase", "other"],
      lipa_namba_provider: ["mpesa", "airtel_money", "tigo_pesa"],
      payment_method: ["cash", "lipa_namba"],
      sale_status: ["completed", "voided"],
      sale_type: ["cash", "credit"],
