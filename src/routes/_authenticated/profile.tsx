    ...
    <AppShell>
      <div className="p-4 lg:p-8 max-w-md mx-auto">
        ...
        <div className="card-elev p-5 space-y-3">
          <div>
            <div className="text-xs text-muted-foreground">Jina</div>
            <div className="font-medium">{staff?.full_name}</div>
          </div>
          <div>
            <div className="text-xs text-muted-foreground">Barua pepe</div>
            <div className="font-medium">{staff?.email}</div>
          </div>
          <div>
            <div className="text-xs text-muted-foreground">Nafasi</div>
